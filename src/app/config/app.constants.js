...
const AppConstants = {
    ...
    dev: {
        ...
        PREVIEW: 'https://apps.rodin.space/projects/',
    ...
    stage: {
        ...
        //SOCKET: `${window.location.protocol}//ss.rodin.space/api`,
        SITE: `${window.location.protocol}//${window.extractDomain()}/`,
        PREVIEW: `${window.location.protocol}//apps.${window.extractDomain()}/projects/`,
        PUBLIC: `${window.location.protocol}//apps.${window.extractDomain()}/public/`,
    ...
    test: {
        ...
        // SOCKET: `${window.location.protocol}//ss.rodin.space/api`,
        SITE: `${window.location.protocol}//${window.extractDomain()}/`,
        PREVIEW: `apps.${window.location.protocol}//${window.extractDomain()}/projects/`,
        PUBLIC: `apps.${window.location.protocol}//${window.extractDomain()}/public/`,
        PUBLISH: `apps.${window.location.protocol}//${window.extractDomain()}/`,
        EDITOR: `${window.location.protocol}//editor.${window.extractDomain()}/`,
        GITHUB: '5377f212205e0aa4b4cf',
    },
