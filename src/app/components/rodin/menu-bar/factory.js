  ...
  const menuList = [
    {
      ...
      "subMenus": {
        "newFile": {
          "id": "newFile",
          "name": "New File",
          "hotKey": Utils.bindKey("Alt-N", "Command-N"),
          "template": defaultTemplate,
        },
        "newFolder": {
          "id": "newFolder",
          "name": "New Folder",
          "hotKey": Utils.bindKey("Alt-Shift-N", "Command-Shift-N"),
          "template": defaultTemplate,
        },
        "uploadFile": {
          "id": "uploadFile",
          "name": "Upload File",
          "hotKey": Utils.bindKey("Alt-O", "Command-O"),
          "template": defaultTemplate,
        },
        "uploadFolder": {
          "id": "uploadFolder",
          "name": "Upload Folder",
          "hotKey": Utils.bindKey("Alt-Shift-O", "Command-Shift-O"),
          "template": defaultTemplate,
        },
        "saveFile": {
          "id": "saveFile",
